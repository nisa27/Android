...
import com.nisa.myuas.response.BeritaItem;
...
class AdapterBerita extends RecyclerView.Adapter<AdapterBerita.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // Layout inflater
        View itemView = LayoutInflater.from(context).inflate(R.layout.berita_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // Dapatkan url gambar
        final String urlGambarBerita = "http://192.168.43.127/simple-api-portal-berita-master/images/" + berita.get(position).getFoto();
